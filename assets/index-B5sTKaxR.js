...
#define LOW_PRECISION`),t}const Cm={[bs]:"SHADOWMAP_TYPE_PCF",[Ii]:"SHADOWMAP_TYPE_VSM"};function Pm(i){return Cm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Lm={[Xn]:"ENVMAP_TYPE_CUBE",[pi]:"ENVMAP_TYPE_CUBE",[Us]:"ENVMAP_TYPE_CUBE_UV"};function Dm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Lm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Im={[pi]:"ENVMAP_MODE_REFRACTION"};function Um(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Im[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Nm={[tl]:"ENVMAP_BLENDING_MULTIPLY",[vc]:"ENVMAP_BLENDING_MIX",[Mc]:"ENVMAP_BLENDING_ADD"};function Fm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Nm[i.combine]||"ENVMAP_BLENDING_NONE"}function Om(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Bm(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Pm(e),c=Dm(e),h=Um(e),u=Fm(e),f=Om(e),p=Sm(e),_=ym(r),v=s.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
}`;class cg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new Rl(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Ye({vertexShader:og,fragmentShader:lg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new $t(new Ei(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hg extends Si{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,f=null,p=null,_=null;const v=typeof XRWebGLBinding<"u",m=new cg,d={},T=e.getContextAttributes();let b=null,y=null;const w=[],R=[],C=new pt;let N=null;const x=new Pe;x.viewport=new de;const S=new Pe;S.viewport=new de;const P=[x,S],B=new _u;let O=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let Q=w[Y];return Q===void 0&&(Q=new hr,w[Y]=Q),Q.getTargetRaySpace()},this.getControllerGrip=function(Y){let Q=w[Y];return Q===void 0&&(Q=new hr,w[Y]=Q),Q.getGripSpace()},this.getHand=function(Y){let Q=w[Y];return Q===void 0&&(Q=new hr,w[Y]=Q),Q.getHandSpace()};function H(Y){const Q=R.indexOf(Y.inputSource);if(Q===-1)return;const Mt=w[Q];Mt!==void 0&&(Mt.update(Y.inputSource,Y.frame,c||a),Mt.dispatchEvent({type:Y.type,data:Y.inputSource}))}function k(){s.removeEventListener("select",H),s.removeEventListener("selectstart",H),s.removeEventListener("selectend",H),s.removeEventListener("squeeze",H),s.removeEventListener("squeezestart",H),s.removeEventListener("squeezeend",H),s.removeEventListener("end",k),s.removeEventListener("inputsourceschange",z);for(let Y=0;Y<w.length;Y++){const Q=R[Y];Q!==null&&(R[Y]=null,w[Y].disconnect(Q))}O=null,q=null,m.reset();for(const Y in d)delete d[Y];t.setRenderTarget(b),p=null,f=null,u=null,s=null,y=null,ne.stop(),n.isPresenting=!1,t.setPixelRatio(N),t.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){r=Y,n.isPresenting===!0&&Ct("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&Ct("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u===null&&v&&(u=new XRWebGLBinding(s,e)),u},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(Y){if(s=Y,s!==null){if(b=t.getRenderTarget(),s.addEventListener("select",H),s.addEventListener("selectstart",H),s.addEventListener("selectend",H),s.addEventListener("squeeze",H),s.addEventListener("squeezestart",H),s.addEventListener("squeezeend",H),s.addEventListener("end",k),s.addEventListener("inputsourceschange",z),T.xrCompatible!==!0&&await e.makeXRCompatible(),N=t.getPixelRatio(),t.getSize(C),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let Mt=null,It=null,yt=null;T.depth&&(yt=T.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,Mt=T.stencil?Wn:_n,It=T.stencil?Gi:nn);const qt={colorFormat:e.RGBA8,depthFormat:yt,scaleFactor:r};u=this.getBinding(),f=u.createProjectionLayer(qt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),y=new Xe(f.textureWidth,f.textureHeight,{format:Ve,type:Fe,depthTexture:new ki(f.textureWidth,f.textureHeight,It,void 0,void 0,void 0,void 0,void 0,void 0,Mt),stencilBuffer:T.stencil,colorSpace:t.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const Mt={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,Mt),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new Xe(p.framebufferWidth,p.framebufferHeight,{format:Ve,type:Fe,colorSpace:t.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),ne.setContext(s),ne.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function z(Y){for(let Q=0;Q<Y.removed.length;Q++){const Mt=Y.removed[Q],It=R.indexOf(Mt);It>=0&&(R[It]=null,w[It].disconnect(Mt))}for(let Q=0;Q<Y.added.length;Q++){const Mt=Y.added[Q];let It=R.indexOf(Mt);if(It===-1){for(let qt=0;qt<w.length;qt++)if(qt>=R.length){R.push(Mt),It=qt;break}else if(R[qt]===null){R[qt]=Mt,It=qt;break}if(It===-1)break}const yt=w[It];yt&&yt.connect(Mt)}}const j=new L,ft=new L;function at(Y,Q,Mt){j.setFromMatrixPosition(Q.matrixWorld),ft.setFromMatrixPosition(Mt.matrixWorld);const It=j.distanceTo(ft),yt=Q.projectionMatrix.elements,qt=Mt.projectionMatrix.elements,ie=yt[14]/(yt[10]-1),Vt=yt[14]/(yt[10]+1),K=(yt[9]+1)/yt[5],et=(yt[9]-1)/yt[5],$=(yt[8]-1)/yt[0],mt=(qt[8]+1)/qt[0],A=ie*$,Pt=ie*mt,xt=It/(-$+mt),Ut=xt*-$;if(Q.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(Ut),Y.translateZ(xt),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),yt[10]===-1)Y.projectionMatrix.copy(Q.projectionMatrix),Y.projectionMatrixInverse.copy(Q.projectionMatrixInverse);else{const st=ie+xt,E=Vt+xt,g=A-Ut,I=Pt+(It-Ut),W=K*Vt/E*st,Z=et*Vt/E*st;Y.projectionMatrix.makePerspective(g,I,W,Z,st,E),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function ct(Y,Q){Q===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(Q.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(s===null)return;let Q=Y.near,Mt=Y.far;m.texture!==null&&(m.depthNear>0&&(Q=m.depthNear),m.depthFar>0&&(Mt=m.depthFar)),B.near=S.near=x.near=Q,B.far=S.far=x.far=Mt,(O!==B.near||q!==B.far)&&(s.updateRenderState({depthNear:B.near,depthFar:B.far}),O=B.near,q=B.far),B.layers.mask=Y.layers.mask|6,x.layers.mask=B.layers.mask&3,S.layers.mask=B.layers.mask&5;const It=Y.parent,yt=B.cameras;ct(B,It);for(let qt=0;qt<yt.length;qt++)ct(yt[qt],It);yt.length===2?at(B,x,S):B.projectionMatrix.copy(x.projectionMatrix),zt(Y,B,It)};function zt(Y,Q,Mt){Mt===null?Y.matrix.copy(Q.matrixWorld):(Y.matrix.copy(Mt.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(Q.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(Q.projectionMatrix),Y.projectionMatrixInverse.copy(Q.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=_i*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(Y){l=Y,f!==null&&(f.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(B)},this.getCameraTexture=function(Y){return d[Y]};let Ot=null;function ee(Y,Q){if(h=Q.getViewerPose(c||a),_=Q,h!==null){const Mt=h.views;p!==null&&(t.setRenderTargetFramebuffer(y,p.framebuffer),t.setRenderTarget(y));let It=!1;Mt.length!==B.cameras.length&&(B.cameras.length=0,It=!0);for(let Vt=0;Vt<Mt.length;Vt++){const K=Mt[Vt];let et=null;if(p!==null)et=p.getViewport(K);else{const mt=u.getViewSubImage(f,K);et=mt.viewport,Vt===0&&(t.setRenderTargetTextures(y,mt.colorTexture,mt.depthStencilTexture),t.setRenderTarget(y))}let $=P[Vt];$===void 0&&($=new Pe,$.layers.enable(Vt),$.viewport=new de,P[Vt]=$),$.matrix.fromArray(K.transform.matrix),$.matrix.decompose($.position,$.quaternion,$.scale),$.projectionMatrix.fromArray(K.projectionMatrix),$.projectionMatrixInverse.copy($.projectionMatrix).invert(),$.viewport.set(et.x,et.y,et.width,et.height),Vt===0&&(B.matrix.copy($.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),It===!0&&B.cameras.push($)}const yt=s.enabledFeatures;if(yt&&yt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&v){u=n.getBinding();const Vt=u.getDepthInformation(Mt[0]);Vt&&Vt.isValid&&Vt.texture&&m.init(Vt,s.renderState)}if(yt&&yt.includes("camera-access")&&v){t.state.unbindTexture(),u=n.getBinding();for(let Vt=0;Vt<Mt.length;Vt++){const K=Mt[Vt].camera;if(K){let et=d[K];et||(et=new Rl,d[K]=et);const $=u.getCameraImage(K);et.sourceTexture=$}}}}for(let Mt=0;Mt<w.length;Mt++){const It=R[Mt],yt=w[Mt];It!==null&&yt!==void 0&&yt.update(It,Q,c||a)}Ot&&Ot(Y,Q),Q.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:Q}),_=null}const ne=new zl;ne.setAnimationLoop(ee),this.setAnimationLoop=function(Y){Ot=Y},this.dispose=function(){}}}const Bn=new qe,ug=new he;function fg(i,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,El(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function s(m,d,T,b,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?r(m,d):d.isMeshToonMaterial?(r(m,d),u(m,d)):d.isMeshPhongMaterial?(r(m,d),h(m,d)):d.isMeshStandardMaterial?(r(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,y)):d.isMeshMatcapMaterial?(r(m,d),_(m,d)):d.isMeshDepthMaterial?r(m,d):d.isMeshDistanceMaterial?(r(m,d),v(m,d)):d.isMeshNormalMaterial?r(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?l(m,d,T,b):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Le&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Le&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const T=t.get(d),b=T.envMap,y=T.envMapRotation;b&&(m.envMap.value=b,Bn.copy(y),Bn.x*=-1,Bn.y*=-1,Bn.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Bn.y*=-1,Bn.z*=-1),m.envMapRotation.value.setFromMatrix4(ug.makeRotationFromEuler(Bn)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,T,b){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*T,m.scale.value=b*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function h(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function u(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,T){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Le&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const T=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function dg(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,b){const y=b.program;n.uniformBlockBinding(T,y)}function c(T,b){let y=s[T.id];y===void 0&&(_(T),y=h(T),s[T.id]=y,T.addEventListener("dispose",m));const w=b.program;n.updateUBOMapping(T,w);const R=t.render.frame;r[T.id]!==R&&(f(T),r[T.id]=R)}function h(T){const b=u();T.__bindingPointIndex=b;const y=i.createBuffer(),w=T.__size,R=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,w,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,y),y}function u(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return Yt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const b=s[T.id],y=T.uniforms,w=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let R=0,C=y.length;R<C;R++){const N=Array.isArray(y[R])?y[R]:[y[R]];for(let x=0,S=N.length;x<S;x++){const P=N[x];if(p(P,R,x,w)===!0){const B=P.__offset,O=Array.isArray(P.value)?P.value:[P.value];let q=0;for(let H=0;H<O.length;H++){const k=O[H],z=v(k);typeof k=="number"||typeof k=="boolean"?(P.__data[0]=k,i.bufferSubData(i.UNIFORM_BUFFER,B+q,P.__data)):k.isMatrix3?(P.__data[0]=k.elements[0],P.__data[1]=k.elements[1],P.__data[2]=k.elements[2],P.__data[3]=0,P.__data[4]=k.elements[3],P.__data[5]=k.elements[4],P.__data[6]=k.elements[5],P.__data[7]=0,P.__data[8]=k.elements[6],P.__data[9]=k.elements[7],P.__data[10]=k.elements[8],P.__data[11]=0):(k.toArray(P.__data,q),q+=z.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,B,P.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(T,b,y,w){const R=T.value,C=b+"_"+y;if(w[C]===void 0)return typeof R=="number"||typeof R=="boolean"?w[C]=R:w[C]=R.clone(),!0;{const N=w[C];if(typeof R=="number"||typeof R=="boolean"){if(N!==R)return w[C]=R,!0}else if(N.equals(R)===!1)return N.copy(R),!0}return!1}function _(T){const b=T.uniforms;let y=0;const w=16;for(let C=0,N=b.length;C<N;C++){const x=Array.isArray(b[C])?b[C]:[b[C]];for(let S=0,P=x.length;S<P;S++){const B=x[S],O=Array.isArray(B.value)?B.value:[B.value];for(let q=0,H=O.length;q<H;q++){const k=O[q],z=v(k),j=y%w,ft=j%z.boundary,at=j+ft;y+=ft,at!==0&&w-at<z.storage&&(y+=w-at),B.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=y,y+=z.storage}}}const R=y%w;return R>0&&(y+=w-R),T.__size=y,T.__cache={},this}function v(T){const b={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(b.boundary=4,b.storage=4):T.isVector2?(b.boundary=8,b.storage=8):T.isVector3||T.isColor?(b.boundary=16,b.storage=12):T.isVector4?(b.boundary=16,b.storage=16):T.isMatrix3?(b.boundary=48,b.storage=48):T.isMatrix4?(b.boundary=64,b.storage=64):T.isTexture?Ct("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ct("WebGLRenderer: Unsupported uniform value type.",T),b}function m(T){const b=T.target;b.removeEventListener("dispose",m);const y=a.indexOf(b.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function d(){for(const T in s)i.deleteBuffer(s[T]);a=[],s={},r={}}return{bind:l,update:c,dispose:d}}const pg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Je=null;function mg(){return Je===null&&(Je=new xh(pg,16,16,mi,gn),Je.name="DFG_LUT",Je.minFilter=ve,Je.magFilter=ve,Je.wrapS=dn,Je.wrapT=dn,Je.generateMipmaps=!1,Je.needsUpdate=!0),Je}class gg{constructor(t={}){const{canvas:e=Pc(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:f=!1,outputBufferType:p=Fe}=t;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const v=p,m=new Set([Aa,Ta,ba]),d=new Set([Fe,nn,Vi,Gi,ya,Ea]),T=new Uint32Array(4),b=new Int32Array(4);let y=null,w=null;const R=[],C=[];let N=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let S=!1;this._outputColorSpace=ze;let P=0,B=0,O=null,q=-1,H=null;const k=new de,z=new de;let j=null;const ft=new Zt(0);let at=0,ct=e.width,zt=e.height,Ot=1,ee=null,ne=null;const Y=new de(0,0,ct,zt),Q=new de(0,0,ct,zt);let Mt=!1;const It=new Ia;let yt=!1,qt=!1;const ie=new he,Vt=new L,K=new de,et={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let $=!1;function mt(){return O===null?Ot:1}let A=n;function Pt(M,U){return e.getContext(M,U)}try{const M={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Ma}`),e.addEventListener("webglcontextlost",Bt,!1),e.addEventListener("webglcontextrestored",ae,!1),e.addEventListener("webglcontextcreationerror",jt,!1),A===null){const U="webgl2";if(A=Pt(U,M),A===null)throw Pt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Yt("WebGLRenderer: "+M.message),M}let xt,Ut,st,E,g,I,W,Z,X,At,rt,bt,Nt,tt,ht,Tt,wt,lt,kt,D,_t,it,vt,nt;function J(){xt=new mp(A),xt.init(),it=new ag(A,xt),Ut=new ap(A,xt,t,it),st=new sg(A,xt),Ut.reversedDepthBuffer&&f&&st.buffers.depth.setReversed(!0),E=new xp(A),g=new km,I=new rg(A,xt,st,g,Ut,it,E),W=new lp(x),Z=new pp(x),X=new Su(A),vt=new sp(A,X),At=new gp(A,X,E,vt),rt=new Mp(A,At,X,E),kt=new vp(A,Ut,I),Tt=new op(g),bt=new Hm(x,W,Z,xt,Ut,vt,Tt),Nt=new fg(x,g),tt=new Xm,ht=new $m(xt),lt=new ip(x,W,Z,st,rt,_,l),wt=new ng(x,rt,Ut),nt=new dg(A,E,Ut,st),D=new rp(A,xt,E),_t=new _p(A,xt,E),E.programs=bt.programs,x.capabilities=Ut,x.extensions=xt,x.properties=g,x.renderLists=tt,x.shadowMap=wt,x.state=st,x.info=E}J(),v!==Fe&&(N=new yp(v,e.width,e.height,s,r));const ot=new hg(x,A);this.xr=ot,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const M=xt.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=xt.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Ot},this.setPixelRatio=function(M){M!==void 0&&(Ot=M,this.setSize(ct,zt,!1))},this.getSize=function(M){return M.set(ct,zt)},this.setSize=function(M,U,G=!0){if(ot.isPresenting){Ct("WebGLRenderer: Can't change size while VR device is presenting.");return}ct=M,zt=U,e.width=Math.floor(M*Ot),e.height=Math.floor(U*Ot),G===!0&&(e.style.width=M+"px",e.style.height=U+"px"),N!==null&&N.setSize(e.width,e.height),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(ct*Ot,zt*Ot).floor()},this.setDrawingBufferSize=function(M,U,G){ct=M,zt=U,Ot=G,e.width=Math.floor(M*G),e.height=Math.floor(U*G),this.setViewport(0,0,M,U)},this.setEffects=function(M){if(v===Fe){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let U=0;U<M.length;U++)if(M[U].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}N.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(k)},this.getViewport=function(M){return M.copy(Y)},this.setViewport=function(M,U,G,V){M.isVector4?Y.set(M.x,M.y,M.z,M.w):Y.set(M,U,G,V),st.viewport(k.copy(Y).multiplyScalar(Ot).round())},this.getScissor=function(M){return M.copy(Q)},this.setScissor=function(M,U,G,V){M.isVector4?Q.set(M.x,M.y,M.z,M.w):Q.set(M,U,G,V),st.scissor(z.copy(Q).multiplyScalar(Ot).round())},this.getScissorTest=function(){return Mt},this.setScissorTest=function(M){st.setScissorTest(Mt=M)},this.setOpaqueSort=function(M){ee=M},this.setTransparentSort=function(M){ne=M},this.getClearColor=function(M){return M.copy(lt.getClearColor())},this.setClearColor=function(){lt.setClearColor(...arguments)},this.getClearAlpha=function(){return lt.getClearAlpha()},this.setClearAlpha=function(){lt.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,G=!0){let V=0;if(M){let F=!1;if(O!==null){const ut=O.texture.format;F=m.has(ut)}if(F){const ut=O.texture.type,St=d.has(ut),gt=lt.getClearColor(),Et=lt.getClearAlpha(),Rt=gt.r,Ft=gt.g,Lt=gt.b;St?(T[0]=Rt,T[1]=Ft,T[2]=Lt,T[3]=Et,A.clearBufferuiv(A.COLOR,0,T)):(b[0]=Rt,b[1]=Ft,b[2]=Lt,b[3]=Et,A.clearBufferiv(A.COLOR,0,b))}else V|=A.COLOR_BUFFER_BIT}U&&(V|=A.DEPTH_BUFFER_BIT),G&&(V|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Bt,!1),e.removeEventListener("webglcontextrestored",ae,!1),e.removeEventListener("webglcontextcreationerror",jt,!1),lt.dispose(),tt.dispose(),ht.dispose(),g.dispose(),W.dispose(),Z.dispose(),rt.dispose(),vt.dispose(),nt.dispose(),bt.dispose(),ot.dispose(),ot.removeEventListener("sessionstart",Ha),ot.removeEventListener("sessionend",ka),Rn.stop()};function Bt(M){M.preventDefault(),io("WebGLRenderer: Context Lost."),S=!0}function ae(){io("WebGLRenderer: Context Restored."),S=!1;const M=E.autoReset,U=wt.enabled,G=wt.autoUpdate,V=wt.needsUpdate,F=wt.type;J(),E.autoReset=M,wt.enabled=U,wt.autoUpdate=G,wt.needsUpdate=V,wt.type=F}function jt(M){Yt("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function Ze(M){const U=M.target;U.removeEventListener("dispose",Ze),rn(U)}function rn(M){Wl(M),g.remove(M)}function Wl(M){const U=g.get(M).programs;U!==void 0&&(U.forEach(function(G){bt.releaseProgram(G)}),M.isShaderMaterial&&bt.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,G,V,F,ut){U===null&&(U=et);const St=F.isMesh&&F.matrixWorld.determinant()<0,gt=ql(M,U,G,V,F);st.setMaterial(V,St);let Et=G.index,Rt=1;if(V.wireframe===!0){if(Et=At.getWireframeAttribute(G),Et===void 0)return;Rt=2}const Ft=G.drawRange,Lt=G.attributes.position;let Wt=Ft.start*Rt,se=(Ft.start+Ft.count)*Rt;ut!==null&&(Wt=Math.max(Wt,ut.start*Rt),se=Math.min(se,(ut.start+ut.count)*Rt)),Et!==null?(Wt=Math.max(Wt,0),se=Math.min(se,Et.count)):Lt!=null&&(Wt=Math.max(Wt,0),se=Math.min(se,Lt.count));const ue=se-Wt;if(ue<0||ue===1/0)return;vt.setup(F,V,gt,G,Et);let fe,re=D;if(Et!==null&&(fe=X.get(Et),re=_t,re.setIndex(fe)),F.isMesh)V.wireframe===!0?(st.setLineWidth(V.wireframeLinewidth*mt()),re.setMode(A.LINES)):re.setMode(A.TRIANGLES);else if(F.isLine){let Dt=V.linewidth;Dt===void 0&&(Dt=1),st.setLineWidth(Dt*mt()),F.isLineSegments?re.setMode(A.LINES):F.isLineLoop?re.setMode(A.LINE_LOOP):re.setMode(A.LINE_STRIP)}else F.isPoints?re.setMode(A.POINTS):F.isSprite&&re.setMode(A.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Hi("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),re.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(xt.get("WEBGL_multi_draw"))re.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Dt=F._multiDrawStarts,Qt=F._multiDrawCounts,Kt=F._multiDrawCount,De=Et?X.get(Et).bytesPerElement:1,Zn=g.get(V).currentProgram.getUniforms();for(let Ie=0;Ie<Kt;Ie++)Zn.setValue(A,"_gl_DrawID",Ie),re.render(Dt[Ie]/De,Qt[Ie])}else if(F.isInstancedMesh)re.renderInstances(Wt,ue,F.count);else if(G.isInstancedBufferGeometry){const Dt=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,Qt=Math.min(G.instanceCount,Dt);re.renderInstances(Wt,ue,Qt)}else re.render(Wt,ue)};function Ga(M,U,G){M.transparent===!0&&M.side===fn&&M.forceSinglePass===!1?(M.side=Le,M.needsUpdate=!0,ji(M,U,G),M.side=wn,M.needsUpdate=!0,ji(M,U,G),M.side=fn):ji(M,U,G)}this.compile=function(M,U,G=null){G===null&&(G=M),w=ht.get(G),w.init(U),C.push(w),G.traverseVisible(function(F){F.isLight&&F.layers.test(U.layers)&&(w.pushLight(F),F.castShadow&&w.pushShadow(F))}),M!==G&&M.traverseVisible(function(F){F.isLight&&F.layers.test(U.layers)&&(w.pushLight(F),F.castShadow&&w.pushShadow(F))}),w.setupLights();const V=new Set;return M.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const ut=F.material;if(ut)if(Array.isArray(ut))for(let St=0;St<ut.length;St++){const gt=ut[St];Ga(gt,G,F),V.add(gt)}else Ga(ut,G,F),V.add(ut)}),w=C.pop(),V},this.compileAsync=function(M,U,G=null){const V=this.compile(M,U,G);return new Promise(F=>{function ut(){if(V.forEach(function(St){g.get(St).currentProgram.isReady()&&V.delete(St)}),V.size===0){F(M);return}setTimeout(ut,10)}xt.get("KHR_parallel_shader_compile")!==null?ut():setTimeout(ut,10)})};let Vs=null;function Xl(M){Vs&&Vs(M)}function Ha(){Rn.stop()}function ka(){Rn.start()}const Rn=new zl;Rn.setAnimationLoop(Xl),typeof self<"u"&&Rn.setContext(self),this.setAnimationLoop=function(M){Vs=M,ot.setAnimationLoop(M),M===null?Rn.stop():Rn.start()},ot.addEventListener("sessionstart",Ha),ot.addEventListener("sessionend",ka),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){Yt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;const G=ot.enabled===!0&&ot.isPresenting===!0,V=N!==null&&(O===null||G)&&N.begin(x,O);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),ot.enabled===!0&&ot.isPresenting===!0&&(N===null||N.isCompositing()===!1)&&(ot.cameraAutoUpdate===!0&&ot.updateCamera(U),U=ot.getCamera()),M.isScene===!0&&M.onBeforeRender(x,M,U,O),w=ht.get(M,C.length),w.init(U),C.push(w),ie.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),It.setFromProjectionMatrix(ie,Qe,U.reversedDepth),qt=this.localClippingEnabled,yt=Tt.init(this.clippingPlanes,qt),y=tt.get(M,R.length),y.init(),R.push(y),ot.enabled===!0&&ot.isPresenting===!0){const St=x.xr.getDepthSensingMesh();St!==null&&Gs(St,U,-1/0,x.sortObjects)}Gs(M,U,0,x.sortObjects),y.finish(),x.sortObjects===!0&&y.sort(ee,ne),$=ot.enabled===!1||ot.isPresenting===!1||ot.hasDepthSensing()===!1,$&&lt.addToRenderList(y,M),this.info.render.frame++,yt===!0&&Tt.beginShadows();const F=w.state.shadowsArray;if(wt.render(F,M,U),yt===!0&&Tt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&N.hasRenderPass())===!1){const St=y.opaque,gt=y.transmissive;if(w.setupLights(),U.isArrayCamera){const Et=U.cameras;if(gt.length>0)for(let Rt=0,Ft=Et.length;Rt<Ft;Rt++){const Lt=Et[Rt];Xa(St,gt,M,Lt)}$&&lt.render(M);for(let Rt=0,Ft=Et.length;Rt<Ft;Rt++){const Lt=Et[Rt];Wa(y,M,Lt,Lt.viewport)}}else gt.length>0&&Xa(St,gt,M,U),$&&lt.render(M),Wa(y,M,U)}O!==null&&B===0&&(I.updateMultisampleRenderTarget(O),I.updateRenderTargetMipmap(O)),V&&N.end(x),M.isScene===!0&&M.onAfterRender(x,M,U),vt.resetDefaultState(),q=-1,H=null,C.pop(),C.length>0?(w=C[C.length-1],yt===!0&&Tt.setGlobalState(x.clippingPlanes,w.state.camera)):w=null,R.pop(),R.length>0?y=R[R.length-1]:y=null};function Gs(M,U,G,V){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)G=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)w.pushLight(M),M.castShadow&&w.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||It.intersectsSprite(M)){V&&K.setFromMatrixPosition(M.matrixWorld).applyMatrix4(ie);const St=rt.update(M),gt=M.material;gt.visible&&y.push(M,St,gt,G,K.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||It.intersectsObject(M))){const St=rt.update(M),gt=M.material;if(V&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),K.copy(M.boundingSphere.center)):(St.boundingSphere===null&&St.computeBoundingSphere(),K.copy(St.boundingSphere.center)),K.applyMatrix4(M.matrixWorld).applyMatrix4(ie)),Array.isArray(gt)){const Et=St.groups;for(let Rt=0,Ft=Et.length;Rt<Ft;Rt++){const Lt=Et[Rt],Wt=gt[Lt.materialIndex];Wt&&Wt.visible&&y.push(M,St,Wt,G,K.z,Lt)}}else gt.visible&&y.push(M,St,gt,G,K.z,null)}}const ut=M.children;for(let St=0,gt=ut.length;St<gt;St++)Gs(ut[St],U,G,V)}function Wa(M,U,G,V){const{opaque:F,transmissive:ut,transparent:St}=M;w.setupLightsView(G),yt===!0&&Tt.setGlobalState(x.clippingPlanes,G),V&&st.viewport(k.copy(V)),F.length>0&&$i(F,U,G),ut.length>0&&$i(ut,U,G),St.length>0&&$i(St,U,G),st.buffers.depth.setTest(!0),st.buffers.depth.setMask(!0),st.buffers.color.setMask(!0),st.setPolygonOffset(!1)}function Xa(M,U,G,V){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[V.id]===void 0){const Wt=xt.has("EXT_color_buffer_half_float")||xt.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[V.id]=new Xe(1,1,{generateMipmaps:!0,type:Wt?gn:Fe,minFilter:kn,samples:Ut.samples,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Jt.workingColorSpace})}const ut=w.state.transmissionRenderTarget[V.id],St=V.viewport||k;ut.setSize(St.z*x.transmissionResolutionScale,St.w*x.transmissionResolutionScale);const gt=x.getRenderTarget(),Et=x.getActiveCubeFace(),Rt=x.getActiveMipmapLevel();x.setRenderTarget(ut),x.getClearColor(ft),at=x.getClearAlpha(),at<1&&x.setClearColor(16777215,.5),x.clear(),$&&lt.render(G);const Ft=x.toneMapping;x.toneMapping=tn;const Lt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),w.setupLightsView(V),yt===!0&&Tt.setGlobalState(x.clippingPlanes,V),$i(M,G,V),I.updateMultisampleRenderTarget(ut),I.updateRenderTargetMipmap(ut),xt.has("WEBGL_multisampled_render_to_texture")===!1){let Wt=!1;for(let se=0,ue=U.length;se<ue;se++){const fe=U[se],{object:re,geometry:Dt,material:Qt,group:Kt}=fe;if(Qt.side===fn&&re.layers.test(V.layers)){const De=Qt.side;Qt.side=Le,Qt.needsUpdate=!0,qa(re,G,V,Dt,Qt,Kt),Qt.side=De,Qt.needsUpdate=!0,Wt=!0}}Wt===!0&&(I.updateMultisampleRenderTarget(ut),I.updateRenderTargetMipmap(ut))}x.setRenderTarget(gt,Et,Rt),x.setClearColor(ft,at),Lt!==void 0&&(V.viewport=Lt),x.toneMapping=Ft}function $i(M,U,G){const V=U.isScene===!0?U.overrideMaterial:null;for(let F=0,ut=M.length;F<ut;F++){const St=M[F],{object:gt,geometry:Et,group:Rt}=St;let Ft=St.material;Ft.allowOverride===!0&&V!==null&&(Ft=V),gt.layers.test(G.layers)&&qa(gt,U,G,Et,Ft,Rt)}}function qa(M,U,G,V,F,ut){M.onBeforeRender(x,U,G,V,F,ut),M.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),F.onBeforeRender(x,U,G,V,M,ut),F.transparent===!0&&F.side===fn&&F.forceSinglePass===!1?(F.side=Le,F.needsUpdate=!0,x.renderBufferDirect(G,U,V,F,M,ut),F.side=wn,F.needsUpdate=!0,x.renderBufferDirect(G,U,V,F,M,ut),F.side=fn):x.renderBufferDirect(G,U,V,F,M,ut),M.onAfterRender(x,U,G,V,F,ut)}function ji(M,U,G){U.isScene!==!0&&(U=et);const V=g.get(M),F=w.state.lights,ut=w.state.shadowsArray,St=F.state.version,gt=bt.getParameters(M,F.state,ut,U,G),Et=bt.getProgramCacheKey(gt);let Rt=V.programs;V.environment=M.isMeshStandardMaterial?U.environment:null,V.fog=U.fog,V.envMap=(M.isMeshStandardMaterial?Z:W).get(M.envMap||V.environment),V.envMapRotation=V.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Rt===void 0&&(M.addEventListener("dispose",Ze),Rt=new Map,V.programs=Rt);let Ft=Rt.get(Et);if(Ft!==void 0){if(V.currentProgram===Ft&&V.lightsStateVersion===St)return Za(M,gt),Ft}else gt.uniforms=bt.getUniforms(M),M.onBeforeCompile(gt,x),Ft=bt.acquireProgram(gt,Et),Rt.set(Et,Ft),V.uniforms=gt.uniforms;const Lt=V.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Lt.clippingPlanes=Tt.uniform),Za(M,gt),V.needsLights=Zl(M),V.lightsStateVersion=St,V.needsLights&&(Lt.ambientLightColor.value=F.state.ambient,Lt.lightProbe.value=F.state.probe,Lt.directionalLights.value=F.state.directional,Lt.directionalLightShadows.value=F.state.directionalShadow,Lt.spotLights.value=F.state.spot,Lt.spotLightShadows.value=F.state.spotShadow,Lt.rectAreaLights.value=F.state.rectArea,Lt.ltc_1.value=F.state.rectAreaLTC1,Lt.ltc_2.value=F.state.rectAreaLTC2,Lt.pointLights.value=F.state.point,Lt.pointLightShadows.value=F.state.pointShadow,Lt.hemisphereLights.value=F.state.hemi,Lt.directionalShadowMap.value=F.state.directionalShadowMap,Lt.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Lt.spotShadowMap.value=F.state.spotShadowMap,Lt.spotLightMatrix.value=F.state.spotLightMatrix,Lt.spotLightMap.value=F.state.spotLightMap,Lt.pointShadowMap.value=F.state.pointShadowMap,Lt.pointShadowMatrix.value=F.state.pointShadowMatrix),V.currentProgram=Ft,V.uniformsList=null,Ft}function Ya(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=Cs.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function Za(M,U){const G=g.get(M);G.outputColorSpace=U.outputColorSpace,G.batching=U.batching,G.batchingColor=U.batchingColor,G.instancing=U.instancing,G.instancingColor=U.instancingColor,G.instancingMorph=U.instancingMorph,G.skinning=U.skinning,G.morphTargets=U.morphTargets,G.morphNormals=U.morphNormals,G.morphColors=U.morphColors,G.morphTargetsCount=U.morphTargetsCount,G.numClippingPlanes=U.numClippingPlanes,G.numIntersection=U.numClipIntersection,G.vertexAlphas=U.vertexAlphas,G.vertexTangents=U.vertexTangents,G.toneMapping=U.toneMapping}function ql(M,U,G,V,F){U.isScene!==!0&&(U=et),I.resetTextureUnits();const ut=U.fog,St=V.isMeshStandardMaterial?U.environment:null,gt=O===null?x.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:gi,Et=(V.isMeshStandardMaterial?Z:W).get(V.envMap||St),Rt=V.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Ft=!!G.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Lt=!!G.morphAttributes.position,Wt=!!G.morphAttributes.normal,se=!!G.morphAttributes.color;let ue=tn;V.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(ue=x.toneMapping);const fe=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,re=fe!==void 0?fe.length:0,Dt=g.get(V),Qt=w.state.lights;if(yt===!0&&(qt===!0||M!==H)){const Ee=M===H&&V.id===q;Tt.setState(V,M,Ee)}let Kt=!1;V.version===Dt.__version?(Dt.needsLights&&Dt.lightsStateVersion!==Qt.state.version||Dt.outputColorSpace!==gt||F.isBatchedMesh&&Dt.batching===!1||!F.isBatchedMesh&&Dt.batching===!0||F.isBatchedMesh&&Dt.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Dt.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Dt.instancing===!1||!F.isInstancedMesh&&Dt.instancing===!0||F.isSkinnedMesh&&Dt.skinning===!1||!F.isSkinnedMesh&&Dt.skinning===!0||F.isInstancedMesh&&Dt.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Dt.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Dt.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Dt.instancingMorph===!1&&F.morphTexture!==null||Dt.envMap!==Et||V.fog===!0&&Dt.fog!==ut||Dt.numClippingPlanes!==void 0&&(Dt.numClippingPlanes!==Tt.numPlanes||Dt.numIntersection!==Tt.numIntersection)||Dt.vertexAlphas!==Rt||Dt.vertexTangents!==Ft||Dt.morphTargets!==Lt||Dt.morphNormals!==Wt||Dt.morphColors!==se||Dt.toneMapping!==ue||Dt.morphTargetsCount!==re)&&(Kt=!0):(Kt=!0,Dt.__version=V.version);let De=Dt.currentProgram;Kt===!0&&(De=ji(V,U,F));let Zn=!1,Ie=!1,Ti=!1;const oe=De.getUniforms(),Re=Dt.uniforms;if(st.useProgram(De.program)&&(Zn=!0,Ie=!0,Ti=!0),V.id!==q&&(q=V.id,Ie=!0),Zn||H!==M){st.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),oe.setValue(A,"projectionMatrix",M.projectionMatrix),oe.setValue(A,"viewMatrix",M.matrixWorldInverse);const Ce=oe.map.cameraPosition;Ce!==void 0&&Ce.setValue(A,Vt.setFromMatrixPosition(M.matrixWorld)),Ut.logarithmicDepthBuffer&&oe.setValue(A,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&oe.setValue(A,"isOrthographic",M.isOrthographicCamera===!0),H!==M&&(H=M,Ie=!0,Ti=!0)}if(Dt.needsLights&&(Qt.state.directionalShadowMap.length>0&&oe.setValue(A,"directionalShadowMap",Qt.state.directionalShadowMap,I),Qt.state.spotShadowMap.length>0&&oe.setValue(A,"spotShadowMap",Qt.state.spotShadowMap,I),Qt.state.pointShadowMap.length>0&&oe.setValue(A,"pointShadowMap",Qt.state.pointShadowMap,I)),F.isSkinnedMesh){oe.setOptional(A,F,"bindMatrix"),oe.setOptional(A,F,"bindMatrixInverse");const Ee=F.skeleton;Ee&&(Ee.boneTexture===null&&Ee.computeBoneTexture(),oe.setValue(A,"boneTexture",Ee.boneTexture,I))}F.isBatchedMesh&&(oe.setOptional(A,F,"batchingTexture"),oe.setValue(A,"batchingTexture",F._matricesTexture,I),oe.setOptional(A,F,"batchingIdTexture"),oe.setValue(A,"batchingIdTexture",F._indirectTexture,I),oe.setOptional(A,F,"batchingColorTexture"),F._colorsTexture!==null&&oe.setValue(A,"batchingColorTexture",F._colorsTexture,I));const Oe=G.morphAttributes;if((Oe.position!==void 0||Oe.normal!==void 0||Oe.color!==void 0)&&kt.update(F,G,De),(Ie||Dt.receiveShadow!==F.receiveShadow)&&(Dt.receiveShadow=F.receiveShadow,oe.setValue(A,"receiveShadow",F.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Re.envMap.value=Et,Re.flipEnvMap.value=Et.isCubeTexture&&Et.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&U.environment!==null&&(Re.envMapIntensity.value=U.environmentIntensity),Re.dfgLUT!==void 0&&(Re.dfgLUT.value=mg()),Ie&&(oe.setValue(A,"toneMappingExposure",x.toneMappingExposure),Dt.needsLights&&Yl(Re,Ti),ut&&V.fog===!0&&Nt.refreshFogUniforms(Re,ut),Nt.refreshMaterialUniforms(Re,V,Ot,zt,w.state.transmissionRenderTarget[M.id]),Cs.upload(A,Ya(Dt),Re,I)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Cs.upload(A,Ya(Dt),Re,I),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&oe.setValue(A,"center",F.center),oe.setValue(A,"modelViewMatrix",F.modelViewMatrix),oe.setValue(A,"normalMatrix",F.normalMatrix),oe.setValue(A,"modelMatrix",F.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Ee=V.uniformsGroups;for(let Ce=0,Hs=Ee.length;Ce<Hs;Ce++){const Cn=Ee[Ce];nt.update(Cn,De),nt.bind(Cn,De)}}return De}function Yl(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function Zl(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return B},this.getRenderTarget=function(){return O},this.setRenderTargetTextures=function(M,U,G){const V=g.get(M);V.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),g.get(M.texture).__webglTexture=U,g.get(M.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:G,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const G=g.get(M);G.__webglFramebuffer=U,G.__useDefaultFramebuffer=U===void 0};const Jl=A.createFramebuffer();this.setRenderTarget=function(M,U=0,G=0){O=M,P=U,B=G;let V=null,F=!1,ut=!1;if(M){const gt=g.get(M);if(gt.__useDefaultFramebuffer!==void 0){st.bindFramebuffer(A.FRAMEBUFFER,gt.__webglFramebuffer),k.copy(M.viewport),z.copy(M.scissor),j=M.scissorTest,st.viewport(k),st.scissor(z),st.setScissorTest(j),q=-1;return}else if(gt.__webglFramebuffer===void 0)I.setupRenderTarget(M);else if(gt.__hasExternalTextures)I.rebindTextures(M,g.get(M.texture).__webglTexture,g.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Ft=M.depthTexture;if(gt.__boundDepthTexture!==Ft){if(Ft!==null&&g.has(Ft)&&(M.width!==Ft.image.width||M.height!==Ft.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");I.setupDepthRenderbuffer(M)}}const Et=M.texture;(Et.isData3DTexture||Et.isDataArrayTexture||Et.isCompressedArrayTexture)&&(ut=!0);const Rt=g.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Rt[U])?V=Rt[U][G]:V=Rt[U],F=!0):M.samples>0&&I.useMultisampledRTT(M)===!1?V=g.get(M).__webglMultisampledFramebuffer:Array.isArray(Rt)?V=Rt[G]:V=Rt,k.copy(M.viewport),z.copy(M.scissor),j=M.scissorTest}else k.copy(Y).multiplyScalar(Ot).floor(),z.copy(Q).multiplyScalar(Ot).floor(),j=Mt;if(G!==0&&(V=Jl),st.bindFramebuffer(A.FRAMEBUFFER,V)&&st.drawBuffers(M,V),st.viewport(k),st.scissor(z),st.setScissorTest(j),F){const gt=g.get(M.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+U,gt.__webglTexture,G)}else if(ut){const gt=U;for(let Et=0;Et<M.textures.length;Et++){const Rt=g.get(M.textures[Et]);A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0+Et,Rt.__webglTexture,G,gt)}}else if(M!==null&&G!==0){const gt=g.get(M.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,gt.__webglTexture,G)}q=-1},this.readRenderTargetPixels=function(M,U,G,V,F,ut,St,gt=0){if(!(M&&M.isWebGLRenderTarget)){Yt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=g.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&St!==void 0&&(Et=Et[St]),Et){st.bindFramebuffer(A.FRAMEBUFFER,Et);try{const Rt=M.textures[gt],Ft=Rt.format,Lt=Rt.type;if(!Ut.textureFormatReadable(Ft)){Yt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ut.textureTypeReadable(Lt)){Yt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-V&&G>=0&&G<=M.height-F&&(M.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+gt),A.readPixels(U,G,V,F,it.convert(Ft),it.convert(Lt),ut))}finally{const Rt=O!==null?g.get(O).__webglFramebuffer:null;st.bindFramebuffer(A.FRAMEBUFFER,Rt)}}},this.readRenderTargetPixelsAsync=async function(M,U,G,V,F,ut,St,gt=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Et=g.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&St!==void 0&&(Et=Et[St]),Et)if(U>=0&&U<=M.width-V&&G>=0&&G<=M.height-F){st.bindFramebuffer(A.FRAMEBUFFER,Et);const Rt=M.textures[gt],Ft=Rt.format,Lt=Rt.type;if(!Ut.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ut.textureTypeReadable(Lt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Wt=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,Wt),A.bufferData(A.PIXEL_PACK_BUFFER,ut.byteLength,A.STREAM_READ),M.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+gt),A.readPixels(U,G,V,F,it.convert(Ft),it.convert(Lt),0);const se=O!==null?g.get(O).__webglFramebuffer:null;st.bindFramebuffer(A.FRAMEBUFFER,se);const ue=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await Lc(A,ue,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,Wt),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,ut),A.deleteBuffer(Wt),A.deleteSync(ue),ut}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,G=0){const V=Math.pow(2,-G),F=Math.floor(M.image.width*V),ut=Math.floor(M.image.height*V),St=U!==null?U.x:0,gt=U!==null?U.y:0;I.setTexture2D(M,0),A.copyTexSubImage2D(A.TEXTURE_2D,G,0,0,St,gt,F,ut),st.unbindTexture()};const Kl=A.createFramebuffer(),$l=A.createFramebuffer();this.copyTextureToTexture=function(M,U,G=null,V=null,F=0,ut=null){ut===null&&(F!==0?(Hi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ut=F,F=0):ut=0);let St,gt,Et,Rt,Ft,Lt,Wt,se,ue;const fe=M.isCompressedTexture?M.mipmaps[ut]:M.image;if(G!==null)St=G.max.x-G.min.x,gt=G.max.y-G.min.y,Et=G.isBox3?G.max.z-G.min.z:1,Rt=G.min.x,Ft=G.min.y,Lt=G.isBox3?G.min.z:0;else{const Oe=Math.pow(2,-F);St=Math.floor(fe.width*Oe),gt=Math.floor(fe.height*Oe),M.isDataArrayTexture?Et=fe.depth:M.isData3DTexture?Et=Math.floor(fe.depth*Oe):Et=1,Rt=0,Ft=0,Lt=0}V!==null?(Wt=V.x,se=V.y,ue=V.z):(Wt=0,se=0,ue=0);const re=it.convert(U.format),Dt=it.convert(U.type);let Qt;U.isData3DTexture?(I.setTexture3D(U,0),Qt=A.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(I.setTexture2DArray(U,0),Qt=A.TEXTURE_2D_ARRAY):(I.setTexture2D(U,0),Qt=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,U.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,U.unpackAlignment);const Kt=A.getParameter(A.UNPACK_ROW_LENGTH),De=A.getParameter(A.UNPACK_IMAGE_HEIGHT),Zn=A.getParameter(A.UNPACK_SKIP_PIXELS),Ie=A.getParameter(A.UNPACK_SKIP_ROWS),Ti=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,fe.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,fe.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Rt),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ft),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Lt);const oe=M.isDataArrayTexture||M.isData3DTexture,Re=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const Oe=g.get(M),Ee=g.get(U),Ce=g.get(Oe.__renderTarget),Hs=g.get(Ee.__renderTarget);st.bindFramebuffer(A.READ_FRAMEBUFFER,Ce.__webglFramebuffer),st.bindFramebuffer(A.DRAW_FRAMEBUFFER,Hs.__webglFramebuffer);for(let Cn=0;Cn<Et;Cn++)oe&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,g.get(M).__webglTexture,F,Lt+Cn),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,g.get(U).__webglTexture,ut,ue+Cn)),A.blitFramebuffer(Rt,Ft,St,gt,Wt,se,St,gt,A.DEPTH_BUFFER_BIT,A.NEAREST);st.bindFramebuffer(A.READ_FRAMEBUFFER,null),st.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(F!==0||M.isRenderTargetTexture||g.has(M)){const Oe=g.get(M),Ee=g.get(U);st.bindFramebuffer(A.READ_FRAMEBUFFER,Kl),st.bindFramebuffer(A.DRAW_FRAMEBUFFER,$l);for(let Ce=0;Ce<Et;Ce++)oe?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Oe.__webglTexture,F,Lt+Ce):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Oe.__webglTexture,F),Re?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Ee.__webglTexture,ut,ue+Ce):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Ee.__webglTexture,ut),F!==0?A.blitFramebuffer(Rt,Ft,St,gt,Wt,se,St,gt,A.COLOR_BUFFER_BIT,A.NEAREST):Re?A.copyTexSubImage3D(Qt,ut,Wt,se,ue+Ce,Rt,Ft,St,gt):A.copyTexSubImage2D(Qt,ut,Wt,se,Rt,Ft,St,gt);st.bindFramebuffer(A.READ_FRAMEBUFFER,null),st.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Re?M.isDataTexture||M.isData3DTexture?A.texSubImage3D(Qt,ut,Wt,se,ue,St,gt,Et,re,Dt,fe.data):U.isCompressedArrayTexture?A.compressedTexSubImage3D(Qt,ut,Wt,se,ue,St,gt,Et,re,fe.data):A.texSubImage3D(Qt,ut,Wt,se,ue,St,gt,Et,re,Dt,fe):M.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,ut,Wt,se,St,gt,re,Dt,fe.data):M.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,ut,Wt,se,fe.width,fe.height,re,fe.data):A.texSubImage2D(A.TEXTURE_2D,ut,Wt,se,St,gt,re,Dt,fe);A.pixelStorei(A.UNPACK_ROW_LENGTH,Kt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,De),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Zn),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ie),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Ti),ut===0&&U.generateMipmaps&&A.generateMipmap(Qt),st.unbindTexture()},this.initRenderTarget=function(M){g.get(M).__webglFramebuffer===void 0&&I.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?I.setTextureCube(M,0):M.isData3DTexture?I.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?I.setTexture2DArray(M,0):I.setTexture2D(M,0),st.unbindTexture()},this.resetState=function(){P=0,B=0,O=null,st.reset(),vt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Qe}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=Jt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Jt._getUnpackColorSpace()}}class _g{constructor(t,e,n){this.camera=t,this.canvas=e,this.scene=n,this.position=new L(0,1.6,0),this.velocity=new L,this.direction=new L,this.moveSpeed=4,this.sprintSpeed=8,this.isSprinting=!1,this.euler=new qe(0,0,0,"YXZ"),this.mouseSensitivity=.002,this.keys={forward:!1,backward:!1,left:!1,right:!1,sprint:!1},this.bobTime=0,this.bobAmount=.05,this.bobSpeed=10,this.createSprintIndicator(),this.createFlashlight(),this.setupControls()}createFlashlight(){this.flashlight=new uu(16775392,12,80,Math.PI/5,.5,1.2),this.flashlight.position.set(.15,-.1,-.2),this.camera.add(this.flashlight),this.camera.add(this.flashlight.target),this.flashlight.target.position.set(0,0,-10),this.scene.add(this.camera),this.flashlightModel=new Tn;const t=new vi(.018,.022,.15,12),e=new $e({color:1710618,roughness:.4,metalness:.6}),n=new $t(t,e);n.rotation.x=Math.PI/2,this.flashlightModel.add(n);const s=new vi(.028,.022,.04,12),r=new $e({color:1118481,roughness:.3,metalness:.7}),a=new $t(s,r);a.rotation.x=Math.PI/2,a.position.z=-.095,this.flashlightModel.add(a);const o=new Ua(.024,16),l=new Ns({color:16777181,transparent:!0,opacity:.9}),c=new $t(o,l);c.position.z=-.116,this.flashlightModel.add(c);const h=new Fs(.021,.004,8,16),u=new $e({color:2236962,roughness:.9});for(let f=0;f<3;f++){const p=new $t(h,u);p.rotation.y=Math.PI/2,p.position.z=.03+f*.025,this.flashlightModel.add(p)}this.flashlightBasePos={x:.22,y:-.25,z:-.35},this.flashlightBaseRot={x:.15,y:-.08,z:.05},this.flashlightModel.position.set(this.flashlightBasePos.x,this.flashlightBasePos.y,this.flashlightBasePos.z),this.flashlightModel.rotation.x=this.flashlightBaseRot.x,this.flashlightModel.rotation.y=this.flashlightBaseRot.y,this.flashlightModel.rotation.z=this.flashlightBaseRot.z,this.camera.add(this.flashlightModel),this.flashlightBobTime=0,this.flashlightIdleTime=0,this.lastMouseX=0,this.lastMouseY=0,this.mouseDeltaX=0,this.mouseDeltaY=0,this.flashlightLag={x:0,y:0,rotX:0,rotY:0}}updateFlashlightBob(t,e,n){this.flashlightIdleTime+=t;const s=Math.sin(this.flashlightIdleTime*1.5)*.003,r=Math.sin(this.flashlightIdleTime*.8)*.002,a=15;this.flashlightLag.x+=(this.mouseDeltaX*3e-4-this.flashlightLag.x)*t*a,this.flashlightLag.y+=(this.mouseDeltaY*2e-4-this.flashlightLag.y)*t*a,this.flashlightLag.rotY+=(-this.mouseDeltaX*.001-this.flashlightLag.rotY)*t*a,this.flashlightLag.rotX+=(-this.mouseDeltaY*8e-4-this.flashlightLag.rotX)*t*a,this.mouseDeltaX*=.9,this.mouseDeltaY*=.9;let o=0,l=0,c=0;if(e){const v=n?12:7,m=n?.025:.008,d=n?.015:.005,T=n?.025:.008;this.flashlightBobTime+=t*v,l=Math.sin(this.flashlightBobTime)*m,o=Math.sin(this.flashlightBobTime*.5)*d,c=Math.sin(this.flashlightBobTime*.5)*T}else this.flashlightBobTime*=.95;const h=this.flashlightBasePos.x+o+r+this.flashlightLag.x,u=this.flashlightBasePos.y+l+s+this.flashlightLag.y,f=this.flashlightBaseRot.z+c,p=this.flashlightBaseRot.x+this.flashlightLag.rotX,_=this.flashlightBaseRot.y+this.flashlightLag.rotY;this.flashlightModel.position.x+=(h-this.flashlightModel.position.x)*.15,this.flashlightModel.position.y+=(u-this.flashlightModel.position.y)*.15,this.flashlightModel.rotation.x+=(p-this.flashlightModel.rotation.x)*.1,this.flashlightModel.rotation.y+=(_-this.flashlightModel.rotation.y)*.1,this.flashlightModel.rotation.z+=(f-this.flashlightModel.rotation.z)*.15}onMouseMove(t,e){this.mouseDeltaX=t,this.mouseDeltaY=e}createSprintIndicator(){this.sprintIndicator=document.getElementById("sprint-indicator")}setupControls(){document.addEventListener("pointerlockchange",()=>{this.isLocked=document.pointerLockElement===this.canvas}),document.addEventListener("mousemove",t=>{this.isLocked&&(this.euler.setFromQuaternion(this.camera.quaternion),this.euler.y-=t.movementX*this.mouseSensitivity,this.euler.x-=t.movementY*this.mouseSensitivity,this.euler.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,this.euler.x)),this.camera.quaternion.setFromEuler(this.euler),this.onMouseMove(t.movementX,t.movementY))}),document.addEventListener("keydown",t=>{this.handleKey(t.code,!0)}),document.addEventListener("keyup",t=>{this.handleKey(t.code,!1)}),this.canvas.addEventListener("click",()=>{!this.isLocked&&window.game?.isPlaying&&this.canvas.requestPointerLock()})}handleKey(t,e){switch(t){case"KeyW":case"ArrowUp":this.keys.forward=e;break;case"KeyS":case"ArrowDown":this.keys.backward=e;break;case"KeyA":case"ArrowLeft":this.keys.left=e;break;case"KeyD":case"ArrowRight":this.keys.right=e;break;case"ShiftLeft":case"ShiftRight":this.keys.sprint=e;break}}update(t){if(!this.isLocked)return;this.direction.set(0,0,0);const e=new L,n=new L;this.camera.getWorldDirection(e),e.y=0,e.normalize(),n.crossVectors(e,new L(0,1,0)),this.keys.forward&&this.direction.add(e),this.keys.backward&&this.direction.sub(e),this.keys.left&&this.direction.sub(n),this.keys.right&&this.direction.add(n),this.direction.normalize();const s=this.direction.length()>0;this.isSprinting=this.keys.sprint&&s;const r=this.isSprinting?this.sprintSpeed:this.moveSpeed;this.sprintIndicator&&(this.isSprinting?this.sprintIndicator.classList.add("active"):this.sprintIndicator.classList.remove("active")),this.velocity.copy(this.direction).multiplyScalar(r*t),this.position.add(this.velocity);const a=80;if(this.position.x=Math.max(-a,Math.min(a,this.position.x)),this.position.z=Math.max(-a,Math.min(a,this.position.z)),s){const o=this.isSprinting?1.5:1;this.bobTime+=t*this.bobSpeed*o;const l=Math.sin(this.bobTime)*this.bobAmount*o;this.position.y=1.6+l}else this.bobTime=0,this.position.y=1.6;this.updateFlashlightBob(t,s,this.isSprinting)}getNoiseLevel(){return this.isSprinting?1:this.direction.length()>0?.3:0}}class xg{constructor(t){this.scene=t,this.trees=[],this.createGround(),this.createTrees(),this.createNecklace(),this.createAmbientLights()}createGround(){const t=new Ei(200,200),e=new $e({color:657925,roughness:1,metalness:0}),n=new $t(t,e);n.rotation.x=-Math.PI/2,this.scene.add(n)}createTrees(){const t=new vi(.15,.25,6,8),e=new $e({color:2957082,roughness:1}),n=300,s=85;for(let r=0;r<n;r++){let a,o;do a=(Math.random()-.5)*s*2,o=(Math.random()-.5)*s*2;while(Math.sqrt(a*a+o*o)<8);const l=this.createTree(t,e);l.position.set(a,0,o),l.rotation.y=Math.random()*Math.PI*2;const c=.8+Math.random()*.6;l.scale.set(c,c,c),this.scene.add(l),this.trees.push(l)}for(let r=0;r<100;r++){const a=r/100*Math.PI*2,o=s+5+Math.random()*10,l=Math.cos(a)*o,c=Math.sin(a)*o,h=this.createTree(t,e);h.position.set(l,0,c),h.rotation.y=Math.random()*Math.PI*2,this.scene.add(h),this.trees.push(h)}}createTree(t,e){const n=new Tn,s=new $t(t,e);s.position.y=3,s.castShadow=!0,n.add(s);const r=new $e({color:1708560,roughness:1});for(let a=0;a<5;a++){const o=new vi(.02,.08,2+Math.random()*2,5),l=new $t(o,r);l.position.y=3+Math.random()*3,l.rotation.x=(Math.random()-.5)*.8,l.rotation.z=Math.random()*Math.PI*2,l.position.x=Math.sin(l.rotation.z)*.3,l.position.z=Math.cos(l.rotation.z)*.3,n.add(l)}return n}createNecklace(){const t=new Tn,e=new Fs(.15,.01,8,20),n=new $e({color:12623968,metalness:.8,roughness:.3,emissive:4202496,emissiveIntensity:.2}),s=new $t(e,n);s.rotation.x=Math.PI/2,t.add(s);const r=new Il;r.moveTo(0,0),r.bezierCurveTo(0,-.05,-.05,-.1,-.1,-.1),r.bezierCurveTo(-.15,-.1,-.15,-.05,-.15,0),r.bezierCurveTo(-.15,.05,0,.15,0,.2),r.bezierCurveTo(0,.15,.15,.05,.15,0),r.bezierCurveTo(.15,-.05,.15,-.1,.1,-.1),r.bezierCurveTo(.05,-.1,0,-.05,0,0);const a=new Oa(r,{depth:.03,bevelEnabled:!0,bevelThickness:.01,bevelSize:.01}),o=new $e({color:16763904,metalness:.9,roughness:.2,emissive:5583616,emissiveIntensity:.3}),l=new $t(a,o);l.scale.set(.5,.5,.5),l.position.y=-.15,l.rotation.z=Math.PI,t.add(l);const c=new _a(16755200,.5,3);c.position.set(0,.2,0),t.add(c),t.position.set(3,.05,4),t.rotation.x=-Math.PI/2+.1,this.scene.add(t),this.necklace=t}createAmbientLights(){const t=new mu(4210752,1);this.scene.add(t);const e=new pu(4474026,.3);e.position.set(50,100,50),this.scene.add(e);const n=new cu(2236979,1118481,.8);this.scene.add(n)}getTreePositions(){return this.trees.map(t=>t.position.clone())}}class vg{constructor(t,e){this.scene=t,this.player=e,this.position=new L(60,0,60),this.isActive=!1,this.isChasing=!1,this.catchDistance=2,this.speed=3,this.chaseSpeed=6,this.currentSpeed=0,this.detectionRange=50,this.hearingRange=35,this.sightRange=25,this.roamTarget=new L,this.roamTimer=0,this.eyeIntensity=0,this.targetEyeIntensity=0,this.createBear(),this.createDangerOverlay()}createBear(){this.bearGroup=new Tn;const t=new Gn(2,16,16),e=new $e({color:2759178,roughness:.9}),n=new $t(t,e);n.scale.set(1,1.2,.9),n.position.y=3,this.bearGroup.add(n);const s=new Gn(1.2,16,16),r=new $t(s,e);r.position.y=5.5,this.bearGroup.add(r);const a=new Gn(.5,12,12),o=new $e({color:1706496,roughness:1}),l=new $t(a,o);l.position.set(0,5.3,.9),l.scale.set(1,.7,.8),this.bearGroup.add(l);const c=new Gn(.4,12,12),h=new $t(c,e);h.position.set(-.8,6.4,0),this.bearGroup.add(h);const u=new $t(c,e);u.position.set(.8,6.4,0),this.bearGroup.add(u);const f=new Gn(.15,12,12);this.eyeMaterial=new Ns({color:16711680,transparent:!0,opacity:0}),this.leftEye=new $t(f,this.eyeMaterial.clone()),this.leftEye.position.set(-.35,5.6,.95),this.bearGroup.add(this.leftEye),this.rightEye=new $t(f,this.eyeMaterial.clone()),this.rightEye.position.set(.35,5.6,.95),this.bearGroup.add(this.rightEye),this.leftEyeLight=new _a(16711680,0,20),this.leftEyeLight.position.copy(this.leftEye.position),this.bearGroup.add(this.leftEyeLight),this.rightEyeLight=new _a(16711680,0,20),this.rightEyeLight.position.copy(this.rightEye.position),this.bearGroup.add(this.rightEyeLight);const p=new Is(.4,1.5,8,8),_=new $t(p,e);_.position.set(-1.8,3.5,0),_.rotation.z=.4,this.bearGroup.add(_);const v=new $t(p,e);v.position.set(1.8,3.5,0),v.rotation.z=-.4,this.bearGroup.add(v);const m=new Is(.5,1.2,8,8),d=new $t(m,e);d.position.set(-.8,1,0),this.bearGroup.add(d);const T=new $t(m,e);T.position.set(.8,1,0),this.bearGroup.add(T),this.bearGroup.position.copy(this.position),this.scene.add(this.bearGroup)}createDangerOverlay(){this.dangerOverlay=document.getElementById("danger-overlay")}activate(){this.isActive=!0,this.setNewRoamTarget()}setNewRoamTarget(){const t=Math.random()*Math.PI*2,e=20+Math.random()*40;this.roamTarget.set(Math.cos(t)*e,0,Math.sin(t)*e),this.roamTimer=5+Math.random()*10}update(t,e){if(!this.isActive)return;const n=this.player.position.clone();n.y=0;const s=this.position.clone();s.y=0;const r=s.distanceTo(n);let a=!1;const o=e?this.hearingRange*1.5:this.hearingRange;if(r<o&&this.player.getNoiseLevel()>.2&&(a=!0),r<this.sightRange){const u=new L(0,0,1).applyQuaternion(this.bearGroup.quaternion),f=n.clone().sub(s).normalize();u.dot(f)>.3&&(a=!0)}a&&r<this.detectionRange?this.isChasing=!0:r>this.detectionRange*1.5&&(this.isChasing=!1);let l;this.isChasing?(l=n,this.currentSpeed=ts.lerp(this.currentSpeed,this.chaseSpeed,t*2)):(this.roamTimer-=t,(this.roamTimer<=0||s.distanceTo(this.roamTarget)<2)&&this.setNewRoamTarget(),l=this.roamTarget,this.currentSpeed=ts.lerp(this.currentSpeed,this.speed,t));const c=l.clone().sub(s).normalize();this.position.add(c.multiplyScalar(this.currentSpeed*t));const h=75;if(this.position.x=Math.max(-h,Math.min(h,this.position.x)),this.position.z=Math.max(-h,Math.min(h,this.position.z)),this.bearGroup.position.copy(this.position),c.length()>.1){const u=Math.atan2(c.x,c.z);this.bearGroup.rotation.y=ts.lerp(this.bearGroup.rotation.y,u,t*3)}r<this.detectionRange?(this.targetEyeIntensity=1-r/this.detectionRange,this.isChasing&&(this.targetEyeIntensity=Math.min(1,this.targetEyeIntensity*2))):this.targetEyeIntensity=.2,this.eyeIntensity=ts.lerp(this.eyeIntensity,this.targetEyeIntensity,t*2),this.leftEye.material.opacity=this.eyeIntensity,this.rightEye.material.opacity=this.eyeIntensity,this.leftEyeLight.intensity=this.eyeIntensity*2,this.rightEyeLight.intensity=this.eyeIntensity*2,this.dangerOverlay&&(this.isChasing&&r<20?this.dangerOverlay.classList.add("active"):this.dangerOverlay.classList.remove("active"))}getDistanceToPlayer(){const t=this.player.position.clone();t.y=0;const e=this.position.clone();return e.y=0,e.distanceTo(t)}hasCaughtPlayer(){return this.isActive&&this.getDistanceToPlayer()<this.catchDistance}}class Mg{constructor(t){this.camera=t,this.listener=new vu,this.camera.add(this.listener),this.audioLoader=new gu,this.sounds={},this.isInitialized=!1,this.stompInterval=null,this.laughterInterval=null,document.addEventListener("click",()=>this.init(),{once:!0})}init(){this.isInitialized||(this.isInitialized=!0,this.audioContext=Va.getContext(),this.generateSounds())}generateSounds(){this.sounds.wind=this.createWindSound(),this.sounds.stomp=this.createStompSound(),this.sounds.laughter=this.createLaughterSound(),this.sounds.heartbeat=this.createHeartbeatSound(),this.sounds.jumpscare=this.createJumpscareSound()}createWindSound(){const t=new Pi(this.listener),e=4,n=this.audioContext.sampleRate,s=this.audioContext.createBuffer(1,e*n,n),r=s.getChannelData(0);for(let a=0;a<r.length;a++){const o=Math.random()*2-1;r[a]=(r[a-1]||0)+.02*o,r[a]*=.1,r[a]*=.5+.5*Math.sin(a/n*.3)}return t.setBuffer(s),t.setLoop(!0),t.setVolume(.3),t}createStompSound(){const t=new Pi(this.listener),e=.5,n=this.audioContext.sampleRate,s=this.audioContext.createBuffer(1,e*n,n),r=s.getChannelData(0);for(let a=0;a<r.length;a++){const o=a/n,l=Math.exp(-o*8),c=Math.sin(o*60*Math.PI*2)*l,h=(Math.random()*2-1)*l*.3;r[a]=(c+h)*.8}return t.setBuffer(s),t.setVolume(.6),t}createLaughterSound(){const t=new Pi(this.listener),e=2,n=this.audioContext.sampleRate,s=this.audioContext.createBuffer(1,e*n,n),r=s.getChannelData(0);for(let a=0;a<r.length;a++){const o=a/n,c=o*4%1,h=c<.3?Math.sin(c/.3*Math.PI):0,u=Math.sin(o*400*Math.PI*2)*.5+Math.sin(o*600*Math.PI*2)*.3+Math.sin(o*200*Math.PI*2)*.2,f=Math.sin(o/e*Math.PI);r[a]=u*h*f*.15}return t.setBuffer(s),t.setVolume(.4),t}createHeartbeatSound(){const t=new Pi(this.listener),e=1,n=this.audioContext.sampleRate,s=this.audioContext.createBuffer(1,e*n,n),r=s.getChannelData(0);for(let a=0;a<r.length;a++){const o=a/n,l=o<.15?Math.sin(o*40*Math.PI*2)*Math.exp(-o*20):0,c=o-.2,h=c>0&&c<.15?Math.sin(c*35*Math.PI*2)*Math.exp(-c*25):0;r[a]=(l+h*.7)*.5}return t.setBuffer(s),t.setLoop(!0),t.setVolume(0),t}createJumpscareSound(){const t=new Pi(this.listener),e=1.5,n=this.audioContext.sampleRate,s=this.audioContext.createBuffer(1,e*n,n),r=s.getChannelData(0);for(let a=0;a<r.length;a++){const o=a/n,l=Math.exp(-o*2),c=Math.sin(o*150*Math.PI*2)*.4+Math.sin(o*220*Math.PI*2)*.3+Math.sin(o*180*Math.PI*2)*.3+(Math.random()*2-1)*.4;r[a]=c*l*.8}return t.setBuffer(s),t.setVolume(.8),t}startAmbience(){if(!this.isInitialized){setTimeout(()=>this.startAmbience(),100);return}this.sounds.wind&&!this.sounds.wind.isPlaying&&this.sounds.wind.play(),this.sounds.heartbeat&&!this.sounds.heartbeat.isPlaying&&this.sounds.heartbeat.play()}playLaughter(){if(!this.isInitialized)return;const t=()=>{this.sounds.laughter&&(this.sounds.laughter.stop(),this.sounds.laughter.play())};setTimeout(t,2e3),this.laughterInterval=setInterval(()=>{Math.random()<.3&&t()},15e3)}updateBearProximity(t){if(!this.isInitialized)return;const e=Math.max(0,1-t/30)*.5;if(this.sounds.heartbeat&&this.sounds.heartbeat.setVolume(e),t<40){if(!this.stompInterval){const n=Math.max(500,2e3-(40-t)*40);this.stompInterval=setInterval(()=>{this.sounds.stomp&&(this.sounds.stomp.stop(),this.sounds.stomp.setVolume(Math.min(.8,(40-t)/40)),this.sounds.stomp.play())},n)}}else this.stompInterval&&(clearInterval(this.stompInterval),this.stompInterval=null)}playJumpscare(){this.isInitialized&&(Object.values(this.sounds).forEach(t=>{t.isPlaying&&t.stop()}),this.stompInterval&&clearInterval(this.stompInterval),this.laughterInterval&&clearInterval(this.laughterInterval),this.sounds.jumpscare&&this.sounds.jumpscare.play())}pause(){this.isInitialized&&(Object.values(this.sounds).forEach(t=>{t.isPlaying&&t.pause()}),this.stompInterval&&(clearInterval(this.stompInterval),this.stompInterval=null),this.laughterInterval&&(clearInterval(this.laughterInterval),this.laughterInterval=null))}resume(){this.isInitialized&&(this.sounds.wind&&!this.sounds.wind.isPlaying&&this.sounds.wind.play(),this.sounds.heartbeat&&!this.sounds.heartbeat.isPlaying&&this.sounds.heartbeat.play(),this.laughterInterval=setInterval(()=>{Math.random()<.3&&this.sounds.laughter&&(this.sounds.laughter.stop(),this.sounds.laughter.play())},15e3))}}class Sg{constructor(t,e,n){this.renderer=t,this.scene=e,this.camera=n,this.renderTarget=new Xe(window.innerWidth,window.innerHeight,{minFilter:ve,magFilter:ve,format:Ve}),this.createPostProcessQuad()}createPostProcessQuad(){const t=`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
